...
public class AssetSetter {
    ...
    public void setInteractiveTile() {
        ...
        gp.tileInteractiveObject[0][23].worldY = 41*gp.tileSize;

        gp.tileInteractiveObject[0][24] = new IT_DryTree(gp);
        gp.tileInteractiveObject[0][24].worldX = 10*gp.tileSize;
        gp.tileInteractiveObject[0][24].worldY = 40*gp.tileSize;

        gp.tileInteractiveObject[0][25] = new IT_DryTree(gp);
        gp.tileInteractiveObject[0][25].worldX = 31*gp.tileSize;
        gp.tileInteractiveObject[0][25].worldY = 21*gp.tileSize;
